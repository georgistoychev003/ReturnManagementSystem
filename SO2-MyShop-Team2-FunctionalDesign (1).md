...
[***1- Introduction	 2***](#_page2_x69.00_y72.92)
...
<a name="_page2_x69.00_y446.92"></a>2- Stakeholders:  
...
||stored inside the system by complying with the GDPR regulation. |||
| :- | :- | :- | :- |
...
2. -<a name="_page6_x69.00_y325.92"></a> User Requirements:  
...
|U4 |As a customer, I want to create an RMA for a product or group of products that meet the return requirements and are within the legal return period of 14 days. |M |myShop Document |
...
| - | :- | - | :- |
|U10 |As a collector, I want to be able to update the status report of an RMA so that the RMA can be processed to the controllers. |S |myShop Document |
|U11 |As a controller, I want to be able to pick an RMA for processing and decide to refund the payment or notify the customer if the product is damaged/missing. |M |myShop Document |
...
|U14 |As a user (customer, controller, collector, administrator) I want to be able to login into the system using my username and password. |M |myShop  Document,  Client Q&A |
...
|U21 |As a controller I want to see a list of all the current RMAs processed by the collector, so that I can decide to refund it or not. |M |Client Q&A |
...
|U23 |As a collector I want to be able to add a description of the product I receive, so that the controller can make an informed decision. |M |Client Q&A |
|U24 |As an administrator I want to be able to view a list of all the users. |M |Client Q&A |

<a name="_page8_x69.00_y72.92"></a>6.1.3- System requirements: 
...
|NF7 |Compatibility |The system must be compatible and optimized to operate in different browsers such as Safari, Google Chrome, Brave, Firefox, Microsoft Edge. |S |Advice |
...
<a name="_page17_x69.00_y72.92"></a>6.5- Navigation diagram:  
